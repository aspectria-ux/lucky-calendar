...
export const luckyDayMeanings: Record<string, { name: string; shortName: string; description: string; color: string }> = {
  'ichiryu-manbai': {
    name: '一粒万倍日',
    shortName: '一粒',
...
export const retrogradeEventMeanings: Record<string, { name: string; shortName: string; description: string; color: string }> = {
  'mercury': {
    name: '水星逆行',
    shortName: '水逆',
